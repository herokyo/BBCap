...
extension SignedNumeric {
    ...
    func format(style: NumberFormatter.Style, minimum: Int = 0, maximum: Int = 0) -> String {
        let formatter = NumberFormatter()
        formatter.numberStyle = style
        formatter.locale = Locale.current
    ...
    func formatDecimal(minimum: Int = 0, maximum: Int = 0) -> String {
        return format(style: .decimal, minimum: minimum, maximum: maximum)
    }
}
